...
{#if $activePanel === 'reference-panel'}
    <div id="reference-panel" class="absolute z-50 grid-rows-[auto_1fr_auto] grid-flow-row pb-0 space-y-0 bg-slate-400 shadow-md w-64 max-w-64" style="top: {position.top}; left: {position.left};">
