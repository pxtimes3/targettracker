...
export class ReferenceTool {
    ...
    // TODO: Gör klart setRefMeasurement
    ...
    private calculateReferenceValues(ref: TargetStoreInterface['reference'], target: TargetStoreInterface['target']): {cm: number, px: number}|undefined
    {
